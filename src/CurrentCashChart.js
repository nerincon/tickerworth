...
import { getCCChartData } from './actions'

class CurrentCashChart extends Component {
  state = {
    showToolTip: false
  }
      ...
      <div style={{display: 'inline-block', paddingLeft: '2rem'}}>
        {this.props.ccchart
          ? <div style={{display: 'inline-block', boxShadow: '2px 4px 3px rgba(0,0,0,0.3)', padding: '20px', marginBottom: '20px', backgroundColor: 'white', borderRadius: '10px'}}>
            <h4 style={{color: 'green', fontFamily: 'Montserrat', textTransform: 'uppercase'}}>Current Cash</h4>
...
export default connect(({ccchart}) => ccchart, {getCCChartData})(withRouter(CurrentCashChart))
