...
import { getTAChartData } from './actions'
      ...
      <div style={{display: 'inline-block', paddingLeft: '2rem'}}>
        {this.props.tachart
          ? <div style={{display: 'inline-block', boxShadow: '2px 4px 3px rgba(0,0,0,0.3)', padding: '20px', marginBottom: '20px', backgroundColor: 'white', borderRadius: '10px'}}>
            <h4 style={{color: 'green', fontFamily: 'Montserrat', textTransform: 'uppercase'}}>Total Assets</h4>
...
export default connect(({tachart}) => tachart, {getTAChartData})(withRouter(TotalAssetsChart))
