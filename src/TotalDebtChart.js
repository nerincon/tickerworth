...
import { getTDChartData } from './actions'

class TotalDebtChart extends Component {
  state = {
    showToolTip: false
  }
...
export default connect(({tdchart}) => tdchart, {getTDChartData})(withRouter(TotalDebtChart))
