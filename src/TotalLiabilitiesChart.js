...
import { getTLChartData } from './actions'

class TotalLiabilitiesChart extends Component {
  state = {
    showToolTip: false
  }
      ...
      <div style={{display: 'inline-block', paddingLeft: '2rem'}}>
        {this.props.tlchart
          ? <div style={{display: 'inline-block', boxShadow: '2px 4px 3px rgba(0,0,0,0.3)', padding: '20px', marginBottom: '20px', backgroundColor: 'white', borderRadius: '10px'}}>
            <h4 style={{color: 'green', fontFamily: 'Montserrat', textTransform: 'uppercase'}}>Total Liabilities</h4>
...
export default connect(({tlchart}) => tlchart, {getTLChartData})(withRouter(TotalLiabilitiesChart))
